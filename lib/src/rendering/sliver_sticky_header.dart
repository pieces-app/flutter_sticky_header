...
class RenderSliverStickyHeader extends RenderSliver with RenderSliverHelpers {
  ...
  void performLayout() {
    ...
    if (header != null) {
      ...
      _updateActivity(headerScrollRatio, constraints.scrollOffset);
  ...
  void _updateActivity(double headerScrollRatio, double scrollOffset) {
    ...
    if (activityHandler != null) {
      WidgetsBinding.instance.scheduleTask(
        () => activityHandler?.call(activity, scrollOffset),
        Priority.touch,
      );
    }
  }
